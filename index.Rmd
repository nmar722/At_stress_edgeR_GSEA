...
gse <- pairwise_termsim(gse)  # compute similarity matrix
...
### GSEA Plot
**Gene Set Integer** corresponds to a gene set in the `gse` object.  
  The first gene set is `1`, the second is `2`, and so on.
